...
3. Get the current Asgard PIN from Mona out-of-band. Fetch vault secrets with: `curl -H "X-Pin: <PIN>" https://asgard-vault.pgallivan.workers.dev/secret/<KEY>`
